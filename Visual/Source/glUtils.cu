...
void setVAO(GLuint &VAO, GLuint &positionVBO, GLuint &colorVBO, GLenum drawHint) {
    ...
    glBufferData(GL_ARRAY_BUFFER, TOTAL_CELLS * sizeof(float3), nullptr, drawHint);
    glVertexAttribPointer(1,3, GL_FLOAT, GL_FALSE, sizeof(float3), static_cast<void *>(nullptr));
